...
const TASK_KIND_LABEL = { BUMP: '⚡ زيادة ميزانية', PAUSE: '⏸️ إيقاف', RESUME: '▶️ استئناف', LAUNCH_CAMPAIGN: '🚀 إطلاق كامبين', SCALE_CAMPAIGN: '📈 سكيل للمنتج الرابح', TEST_CAMPAIGN: '🧪 اختبار مُتحكَّم فيه', PRICE_TEST: '💵 اختبار سعر', SCALE_WINNER: '🚀 اسكيل حملة رابحة' };
